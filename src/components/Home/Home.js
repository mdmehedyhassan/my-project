    ...
    return (
        <div className="flex justify-between items-center mt-4">
            <div className="pl-20 w-2/5 animate__animated animate__heartBeat">
                ...
                <p className="mt-4">I am a Professional Web Developer. I can do HTML, CSS, JS React & others programming languages in professionally. I have learned web development since 2020. </p>
                <div className="mt-4">
